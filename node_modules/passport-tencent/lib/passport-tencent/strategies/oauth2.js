  ...
  if (req.query && req.query.code) {
    ...
    this._oauth2.getOAuthAccessToken(code, { grant_type: 'authorization_code', redirect_uri: callbackURL },
      function(err, accessToken, refreshToken, params) {
        ...
        self._loadUserProfile(accessToken, params.openid, clientIp, function(err, profile) {
 ...
 * @api private
 */
OAuth2Strategy.prototype._loadUserProfile = function(accessToken, openid, clientIp, done) {
  var self = this;
  
  function loadIt() {

    return self.userProfile(accessToken, openid, clientIp, done);
  }
  function skipIt() {
    return done(null);
  }
